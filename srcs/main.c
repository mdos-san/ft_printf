...
int		main()
{
	...
	c = 'a';
	test("char test: |%10.1c|", (void*)&c, 1);
	i = 65599;
	test("wchar test: |%10.1C|", (void*)&i, 2);
	test("s test: |%10.1s|", (void*)"Hello World!", 3);
	test("S test: |%10.1S|", (void*)L"我是一只猫。", 4);
	i = 42;
	test("d test: |%10.1d|", (void*)&i, 5);
	i = -42;
	test("d test: |%10.1d|", (void*)&i, 5);
